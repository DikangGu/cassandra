...
public class SchemaQuery extends SchemaStatement
{
    ...
    {
        super(timer, settings, new DataSpec(generator, seedManager, new DistributionFixed(1), argSelect == ArgSelect.MULTIROW ? statement.getVariables().size() : 1), statement,
              getNames(statement.getVariables()), thriftId, cl);
