...
public class BootStrapper extends ProgressEventNotifierSupport
{
     ...
     */
    public static Collection<Token> getBootstrapTokens(final TokenMetadata metadata, InetAddress address, int delay) throws ConfigurationException
    {
        ...
        if (allocationKeyspace != null)
            return allocateTokens(metadata, address, allocationKeyspace, numTokens, delay);
    ...
    static Collection<Token> allocateTokens(final TokenMetadata metadata,
                                            ...
                                            int delay)
    {
        StorageService.instance.waitForSchema(delay);
