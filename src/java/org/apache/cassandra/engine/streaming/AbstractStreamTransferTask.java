...
{
    private static final Logger logger = LoggerFactory.getLogger(AbstractStreamTransferTask.class);
    ...
    @VisibleForTesting
    public final Map<Integer, OutgoingFileMessage> files = new HashMap<>();

    protected long totalSize;

    protected AbstractStreamTransferTask(StreamSession session, TableId tableId)
    {
